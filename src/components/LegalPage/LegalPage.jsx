  ...
  const legalDocs = {
      ...
      content: (
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          <p className="text-base font-medium text-slate-800">
            This Privacy Policy applies to the website <strong>{siteDomain}</strong> ("Website"), which is owned, operated, and managed by <strong>GlobalInch Private Limited</strong> ("Company", "We", "Us", "Our"), providing <strong>VastuWheels</strong> personalized Vastu analysis reports and architectural consultation services.
          </p>
          <p>
          ...
          <div className="border-l-4 border-emerald-500 pl-4 py-1 bg-emerald-50/40 rounded-r-xl">
            ...
            <p className="mt-1 text-slate-600">
              When you place an order on <strong>{siteDomain}</strong>, we collect personal information voluntarily provided by you, including your Full Name, Email Address, WhatsApp Phone Number, Date of Birth, Property Type, Main Entrance Direction, Primary Vastu Challenge, and Current City.
            </p>
          </div>
          ...
          <div className="border-l-4 border-emerald-500 pl-4 py-1 bg-emerald-50/40 rounded-r-xl">
            ...
            <p className="mt-1 text-slate-600">
              All payments made on <strong>{siteDomain}</strong> are processed securely under <strong>GlobalInch Private Limited</strong> through PCI-DSS compliant payment gateways (Razorpay) using 256-bit SSL encryption. We do NOT store or retain credit card numbers, net banking credentials, or UPI PINs.
            </p>
          </div>
          ...
          <div className="border-l-4 border-emerald-500 pl-4 py-1 bg-emerald-50/40 rounded-r-xl">
            ...
            <p className="mt-1 text-slate-600">
              <strong>GlobalInch Private Limited</strong> does not sell, rent, or trade user data to external marketing agencies. Data is shared strictly with essential technology partners (Razorpay for payment processing and messaging APIs for PDF delivery) solely for fulfilling your order on {siteDomain}.
            </p>
          </div>
        </div>
      )
    ...
    about: {
      ...
      content: (
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          <p className="text-base font-medium text-slate-800">
            <strong>{siteDomain}</strong> is an online portal owned, operated, and managed by <strong>GlobalInch Private Limited</strong>, dedicated to offering scientific Vedic Vastu Science reports, Astro-Vastu analysis, and architectural space energy consultations under the brand name <strong>VastuWheels</strong>.
          </p>
          <p>
          ...
          <div className="bg-amber-50/60 border border-amber-200/80 p-5 rounded-2xl space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-2 text-slate-700 font-semibold">
              ...
              <li><strong>Official Website Domain:</strong> {siteDomain}</li>
    ...
    tnc: {
      ...
      content: (
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          <p className="text-base font-medium text-slate-800">
            Welcome to <strong>{siteDomain}</strong>, operated by <strong>GlobalInch Private Limited</strong> (Registered Address: 3rd Floor, Plot No 3, Near Aapka Bazar, Sector-12 Dwarka, South West Delhi, New Delhi, Delhi 110078). By accessing, browsing, or purchasing services on {siteDomain}, you agree to comply with and be bound by the following Terms and Conditions.
          </p>
          ...
          <div className="border-l-4 border-orange-500 pl-4 py-1 bg-orange-50/50 rounded-r-xl">
            ...
            <p className="mt-1 text-slate-600">
              All financial transactions, invoices, and payment gateway billing on <strong>{siteDomain}</strong> are conducted under the merchant account of <strong>GlobalInch Private Limited</strong>.
            </p>
          </div>
          ...
          <div className="border-l-4 border-orange-500 pl-4 py-1 bg-orange-50/50 rounded-r-xl">
            ...
            <p className="mt-1 text-slate-600">
              These terms shall be governed by and construed in accordance with the laws of India. Any legal proceedings or disputes relating to {siteDomain} or GlobalInch Private Limited shall be subject to the exclusive jurisdiction of the courts in New Delhi, Delhi.
            </p>
          </div>
        </div>
      )
        ...
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          <div className="bg-rose-50 border-2 border-rose-400 p-5 rounded-2xl space-y-2 text-rose-900 font-bold">
            ...
            <p className="text-xs leading-relaxed font-semibold text-rose-800">
              Please read carefully: All products and services offered on <strong>{siteDomain}</strong> by <strong>GlobalInch Private Limited</strong> (including VastuWheels customized Vastu reports and consultations) are personalized digital deliverables. Therefore, <strong>ALL PAYMENTS ARE STRICTLY NON-REFUNDABLE AND NO REFUNDS WILL BE ISSUED ONCE PAYMENT IS COMPLETED.</strong>
            </p>
          </div>
          ...
          <div className="border-l-4 border-orange-500 pl-4 py-1 bg-orange-50/40 rounded-r-xl space-y-2">
            ...
            <p className="text-slate-600">
              Since report calculations and personalized directional analysis begin immediately upon order placement, orders on <strong>{siteDomain}</strong> cannot be cancelled or refunded after successful payment.
            </p>
          </div>
          ...
          <div className="border-l-4 border-orange-500 pl-4 py-1 bg-orange-50/40 rounded-r-xl space-y-2">
            ...
            <ul className="list-disc pl-5 text-slate-700 font-semibold space-y-1">
              ...
              <li><strong>Website Domain:</strong> {siteDomain}</li>
      ...
      content: (
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          <div className="bg-rose-50/60 border border-rose-200 p-4 rounded-2xl text-slate-800 font-semibold text-sm">
            <strong>{siteDomain}</strong> and <strong>GlobalInch Private Limited</strong> are not affiliated with, associated with, or endorsed by Facebook.com, Meta Platforms Inc., Google.com, or Google LLC.
          </div>
          ...
          <div className="border-l-4 border-rose-500 pl-4 py-1 bg-rose-50/30 rounded-r-xl space-y-2">
            ...
            <p className="text-slate-600">
              The recommendations provided on {siteDomain} in the Vastu Wheels Report are based on traditional Vedic Vastu principles and directional calculations. These services are intended for spatial harmony and positive environment alignment.
            </p>
            <p className="text-slate-600">
            ...
            <p className="text-slate-700 font-semibold pt-1">
              Legal Entity: GlobalInch Private Limited | Website: {siteDomain} | Address: 3rd Floor, Plot No 3, Near Aapka Bazar, Sector-12 Dwarka, New Delhi 110078 | Email: globalinchpvt@gmail.com | Phone: +91 9217664304
            </p>
          </div>
        </div>
      )
    ...
    contact: {
      ...
      content: (
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          <p className="text-base font-medium text-slate-800">
            Have questions about your Vastu Report order on <strong>{siteDomain}</strong>? Get in touch with <strong>GlobalInch Private Limited</strong> customer support team.
          </p>
    ...
    <div className="min-h-screen bg-[#fffbf7] text-slate-900 font-sora flex flex-col selection:bg-orange-500 selection:text-white">
      ...
      <footer className="bg-slate-900 text-slate-400 text-xs py-6 px-4 text-center border-t border-slate-800 mt-auto">
        <p className="text-slate-400">
          Copyright 2026 - {siteDomain} (Owned & Operated by GlobalInch Private Limited) | 3rd Floor, Plot No 3, Near Aapka Bazar, Sector-12 Dwarka, New Delhi 110078
        </p>
      </footer>
