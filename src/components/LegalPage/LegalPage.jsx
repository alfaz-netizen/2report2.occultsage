  ...
  const legalDocs = {
      ...
      content: (
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          <p className="text-base font-medium text-slate-800">
            This Privacy Policy applies to the website <strong>fbreport.vastuwheels.com</strong> ("Website"), which is owned, operated, and managed by <strong>GlobalInch Private Limited</strong> ("Company", "We", "Us", "Our"), providing <strong>VastuWheels</strong> personalized Vastu analysis reports and architectural consultation services.
          </p>
          <p>
          ...
          <div className="border-l-4 border-emerald-500 pl-4 py-1 bg-emerald-50/40 rounded-r-xl">
            ...
            <p className="mt-1 text-slate-600">
              When you place an order on <strong>fbreport.vastuwheels.com</strong>, we collect personal information voluntarily provided by you, including your Full Name, Email Address, WhatsApp Phone Number, Date of Birth, Property Type, Main Entrance Direction, Primary Vastu Challenge, and Current City.
            </p>
          </div>
          ...
          <div className="border-l-4 border-emerald-500 pl-4 py-1 bg-emerald-50/40 rounded-r-xl">
            ...
            <p className="mt-1 text-slate-600">
              All payments made on <strong>fbreport.vastuwheels.com</strong> are processed securely under <strong>GlobalInch Private Limited</strong> through PCI-DSS compliant payment gateways (Razorpay) using 256-bit SSL encryption. We do NOT store or retain credit card numbers, net banking credentials, or UPI PINs.
            </p>
          </div>
          ...
          <div className="border-l-4 border-emerald-500 pl-4 py-1 bg-emerald-50/40 rounded-r-xl">
            ...
            <p className="mt-1 text-slate-600">
              <strong>GlobalInch Private Limited</strong> does not sell, rent, or trade user data to external marketing agencies. Data is shared strictly with essential technology partners (Razorpay for payment processing and messaging APIs for PDF delivery) solely for fulfilling your order on fbreport.vastuwheels.com.
            </p>
          </div>
        </div>
      )
    ...
    about: {
      ...
      content: (
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          <p className="text-base font-medium text-slate-800">
            <strong>fbreport.vastuwheels.com</strong> is an online portal owned, operated, and managed by <strong>GlobalInch Private Limited</strong>, dedicated to offering scientific Vedic Vastu Science reports, Astro-Vastu analysis, and architectural space energy consultations under the brand name <strong>VastuWheels</strong>.
          </p>
          <p>
          ...
          <div className="bg-amber-50/60 border border-amber-200/80 p-5 rounded-2xl space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-2 text-slate-700 font-semibold">
              ...
              <li><strong>Official Website Domain:</strong> fbreport.vastuwheels.com</li>
    ...
    tnc: {
      ...
      content: (
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          <p className="text-base font-medium text-slate-800">
            Welcome to <strong>fbreport.vastuwheels.com</strong>, operated by <strong>GlobalInch Private Limited</strong> (Registered Address: Unit No-1166 Vegas Mall, Sector-14 Dwarka, South West Delhi, New Delhi, Delhi 110075). By accessing, browsing, or purchasing services on fbreport.vastuwheels.com, you agree to comply with and be bound by the following Terms and Conditions.
          </p>
          ...
          <div className="border-l-4 border-orange-500 pl-4 py-1 bg-orange-50/50 rounded-r-xl">
            ...
            <p className="mt-1 text-slate-600">
              All financial transactions, invoices, and payment gateway billing on <strong>fbreport.vastuwheels.com</strong> are conducted under the merchant account of <strong>GlobalInch Private Limited</strong>.
            </p>
          </div>
          ...
          <div className="border-l-4 border-orange-500 pl-4 py-1 bg-orange-50/50 rounded-r-xl">
            ...
            <p className="mt-1 text-slate-600">
              These terms shall be governed by and construed in accordance with the laws of India. Any legal proceedings or disputes relating to fbreport.vastuwheels.com or GlobalInch Private Limited shall be subject to the exclusive jurisdiction of the courts in New Delhi, Delhi.
            </p>
          </div>
        </div>
      )
        ...
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          ...
          <div className="border-l-4 border-orange-500 pl-4 py-1 bg-orange-50/40 rounded-r-xl space-y-2">
            ...
            <p className="text-slate-600">
              Since report calculations and personalized directional analysis begin immediately upon order placement, orders on <strong>fbreport.vastuwheels.com</strong> cannot be cancelled or refunded after successful payment.
            </p>
          </div>
          ...
          <div className="border-l-4 border-orange-500 pl-4 py-1 bg-orange-50/40 rounded-r-xl space-y-2">
            ...
            <ul className="list-disc pl-5 text-slate-700 font-semibold space-y-1">
              ...
              <li><strong>Website Domain:</strong> fbreport.vastuwheels.com</li>
      ...
      content: (
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          <div className="bg-rose-50/60 border border-rose-200 p-4 rounded-2xl text-slate-800 font-semibold text-sm">
            <strong>fbreport.vastuwheels.com</strong> and <strong>GlobalInch Private Limited</strong> are not affiliated with, associated with, or endorsed by Facebook.com, Meta Platforms Inc., Google.com, or Google LLC.
          </div>
          ...
          <div className="border-l-4 border-rose-500 pl-4 py-1 bg-rose-50/30 rounded-r-xl space-y-2">
            ...
            <p className="text-slate-600">
              The recommendations provided on fbreport.vastuwheels.com in the Vastu Wheels Report are based on traditional Vedic Vastu principles and directional calculations. These services are intended for spatial harmony and positive environment alignment.
            </p>
            <p className="text-slate-600">
            ...
            <p className="text-slate-700 font-semibold pt-1">
              Legal Entity: GlobalInch Private Limited | Website: fbreport.vastuwheels.com | Address: Unit No-1166 Vegas Mall, Sector-14 Dwarka, New Delhi 110075 | Email: globalinchpvt@gmail.com | Phone: +91 9217664304
            </p>
          </div>
        </div>
      )
    ...
    contact: {
      ...
      content: (
        <div className="space-y-6 text-slate-700 text-sm leading-relaxed">
          <p className="text-base font-medium text-slate-800">
            Have questions about your Vastu Report order on <strong>fbreport.vastuwheels.com</strong>? Get in touch with <strong>GlobalInch Private Limited</strong> customer support team.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
            <div className="bg-slate-50 border border-slate-200 p-5 rounded-2xl space-y-2">
              ...
              <p className="text-slate-600 text-sm font-semibold">fbreport.vastuwheels.com</p>
            </div>
    ...
    <div className="min-h-screen bg-[#fffbf7] text-slate-900 font-sora flex flex-col selection:bg-orange-500 selection:text-white">
          ...
          <aside className="lg:col-span-4 bg-white p-4 md:p-6 rounded-3xl border border-orange-200/80 shadow-md space-y-3 sticky top-24">
            ...
            <div className="pt-4 border-t border-slate-200 text-xs text-slate-600 space-y-2">
              <div className="flex items-center gap-2 text-slate-800 font-bold">
                ...
                <span>fbreport.vastuwheels.com</span>
              </div>
              <div className="flex items-center gap-2 text-slate-800 font-bold">
      ...
      <footer className="bg-slate-900 text-slate-400 text-xs py-6 px-4 text-center border-t border-slate-800 mt-auto">
        <p className="text-slate-400">
          Copyright 2026 - fbreport.vastuwheels.com (Owned & Operated by GlobalInch Private Limited) | Unit No-1166 Vegas Mall, Sector-14 Dwarka, New Delhi 110075
        </p>
      </footer>
