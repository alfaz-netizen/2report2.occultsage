      ...
      <div className="max-w-[1400px] mx-auto space-y-10">
        ...
        <div className="border-t border-slate-800/80 pt-8 space-y-4 text-center text-[11px] text-slate-500">
          ...
          <div className="text-slate-300 font-semibold space-y-1">
            <p>fbreport.vastuwheels.com (VastuWheels Powered & Managed by GlobalInch Private Limited) | globalinchpvt@gmail.com</p>
          ...
          <div className="space-y-1 text-slate-500 leading-relaxed max-w-4xl mx-auto">
            <p>
              fbreport.vastuwheels.com and GlobalInch Private Limited are not a part of Facebook.com or Facebook Inc or Google.com or Google Inc.
            </p>
            <p>
              Additionally, fbreport.vastuwheels.com is not endorsed by Facebook.com or Facebook Inc or Google.com or Google Inc.
            </p>
            <p className="text-amber-400/90 font-medium pt-1">
              * Refund Notice: All digital Vastu reports & services purchased on fbreport.vastuwheels.com are custom generated and strictly NON-REFUNDABLE under any circumstances.
            </p>
          </div>

          {/* Copyright */}
          <div className="text-slate-400 font-bold text-xs pt-2">
            Copyright 2026 - fbreport.vastuwheels.com (GlobalInch Private Limited). All Rights Reserved.
          </div>
